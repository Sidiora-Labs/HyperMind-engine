...
تشغيل LongMemEval الكامل جارٍ، وتأهيل LoCoMo ما زال معلقًا. نجح سيناريو slice-7 الحقيقي والمحدد، لكنه ولا التشخيصات الجزئية يثبتان تأهيل الإصدار. راجع [الحالة المقاسة](docs/evaluation/results.md) و[منهجية التقييم](docs/evaluation/methodology.md)، ولا تعامل النتائج الجزئية كنهائية.
