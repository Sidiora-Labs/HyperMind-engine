    ...
    pub mod hypermind {
        ...
        pub mod protocol {
            ...
            pub struct AsOf {
                ...
                /// The field `known_lsn` in the table `AsOf`
                pub known_lsn: u64,
            }
            ...
            impl AsOf {
                ...
                pub fn create(
                    ...
                    field_known_lsn: impl ::planus::WriteAsDefault<u64, u64>,
                ) -> ::planus::Offset<Self> {
                    ...
                    let prepared_known_lsn = field_known_lsn.prepare(builder, &0);
                    ...
                    unsafe {
                        table_writer.finish(builder, |object_writer| {
                            ...
                            if let ::core::option::Option::Some(prepared_known_lsn) =
                                prepared_known_lsn
                            {
                                object_writer.write::<_, _, 8>(&prepared_known_lsn);
                            }
            ...
            impl<T0, T1, T2, T3> AsOfBuilder<(T0, T1, T2, T3)> {
                /// Setter for the [`known_lsn` field](AsOf#structfield.known_lsn).
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn known_lsn<T4>(self, value: T4) -> AsOfBuilder<(T0, T1, T2, T3, T4)>
                where
                    T4: ::planus::WriteAsDefault<u64, u64>,
                {
                    let (v0, v1, v2, v3) = self.0;
                    AsOfBuilder((v0, v1, v2, v3, value))
                }

                /// Sets the [`known_lsn` field](AsOf#structfield.known_lsn) to the default value.
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn known_lsn_as_default(
                    self,
                ) -> AsOfBuilder<(T0, T1, T2, T3, ::planus::DefaultValue)> {
                    self.known_lsn(::planus::DefaultValue)
                }
            }

            impl<T0, T1, T2, T3, T4> AsOfBuilder<(T0, T1, T2, T3, T4)> {
            ...
            impl<
                ...
                T3: ::planus::WriteAsDefault<u64, u64>,
                T4: ::planus::WriteAsDefault<u64, u64>,
            > ::planus::WriteAs<::planus::Offset<AsOf>> for AsOfBuilder<(T0, T1, T2, T3, T4)>
            {
            ...
            impl<
                ...
                T3: ::planus::WriteAsDefault<u64, u64>,
                T4: ::planus::WriteAsDefault<u64, u64>,
            > ::planus::WriteAsOptional<::planus::Offset<AsOf>>
                for AsOfBuilder<(T0, T1, T2, T3, T4)>
            {
                type Prepared = ::planus::Offset<AsOf>;
            ...
            impl<
                ...
                T3: ::planus::WriteAsDefault<u64, u64>,
                T4: ::planus::WriteAsDefault<u64, u64>,
            > ::planus::WriteAsOffset<AsOf> for AsOfBuilder<(T0, T1, T2, T3, T4)>
            {
                #[inline]
                fn prepare(&self, builder: &mut ::planus::Builder) -> ::planus::Offset<AsOf> {
                    let (v0, v1, v2, v3, v4) = &self.0;
                    AsOf::create(builder, v0, v1, v2, v3, v4)
                }
            }
            ...
            impl<'a> AsOfRef<'a> {
                ...
                /// Getter for the [`known_lsn` field](AsOf#structfield.known_lsn).
                #[inline]
                pub fn known_lsn(&self) -> ::planus::Result<u64> {
                    ::core::result::Result::Ok(self.0.access(4, "AsOf", "known_lsn")?.unwrap_or(0))
                }
            }
            ...
            impl<'a> ::core::fmt::Debug for AsOfRef<'a> {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    ...
                    f.field("known_lsn", &self.known_lsn());
                    f.finish()
                }
            }
            ...
            impl<'a> ::core::convert::TryFrom<AsOfRef<'a>> for AsOf {
                ...
                fn try_from(value: AsOfRef<'a>) -> ::planus::Result<Self> {
                    ::core::result::Result::Ok(Self {
                        ...
                        known_lsn: ::core::convert::TryInto::try_into(value.known_lsn()?)?,
                    })
                }
            }
            ...
            ///
            /// Generated from these locations:
            /// * Table `Checkpoint` in the file `schemas/protocol.fbs:72`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `LatestCheckpoint` in the file `schemas/protocol.fbs:79`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `Attest` in the file `schemas/protocol.fbs:83`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            pub struct Attest {
                ...
                pub client_seq: u64,
                /// The field `helpful` in the table `Attest`
                pub helpful: ::core::option::Option<::planus::alloc::vec::Vec<u64>>,
                /// The field `harmful` in the table `Attest`
                pub harmful: ::core::option::Option<::planus::alloc::vec::Vec<u64>>,
            }
            ...
            impl ::core::default::Default for Attest {
                fn default() -> Self {
                    Self {
                        ...
                        client_seq: 0,
                        helpful: ::core::default::Default::default(),
                        harmful: ::core::default::Default::default(),
                    }
                }
            }
            ...
            impl Attest {
                ...
                pub fn create(
                    ...
                    field_client_seq: impl ::planus::WriteAsDefault<u64, u64>,
                    field_helpful: impl ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                    field_harmful: impl ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                ) -> ::planus::Offset<Self> {
                    let prepared_used = field_used.prepare(builder);
                    let prepared_ignored = field_ignored.prepare(builder);
                    let prepared_client_seq = field_client_seq.prepare(builder, &0);
                    let prepared_helpful = field_helpful.prepare(builder);
                    let prepared_harmful = field_harmful.prepare(builder);
                    ...
                    if prepared_helpful.is_some() {
                        table_writer.write_entry::<::planus::Offset<[u64]>>(3);
                    }
                    if prepared_harmful.is_some() {
                    ...
                    unsafe {
                        table_writer.finish(builder, |object_writer| {
                            ...
                            if let ::core::option::Option::Some(prepared_helpful) = prepared_helpful
                            {
                                object_writer.write::<_, _, 4>(&prepared_helpful);
                            }
                            if let ::core::option::Option::Some(prepared_harmful) = prepared_harmful
                            {
                                object_writer.write::<_, _, 4>(&prepared_harmful);
                            }
                        });
                    }
                    builder.current_offset()
            ...
            impl<T0, T1, T2> AttestBuilder<(T0, T1, T2)> {
                /// Setter for the [`helpful` field](Attest#structfield.helpful).
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn helpful<T3>(self, value: T3) -> AttestBuilder<(T0, T1, T2, T3)>
                where
                    T3: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                {
                    let (v0, v1, v2) = self.0;
                    AttestBuilder((v0, v1, v2, value))
                }

                /// Sets the [`helpful` field](Attest#structfield.helpful) to null.
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn helpful_as_null(self) -> AttestBuilder<(T0, T1, T2, ())> {
                    self.helpful(())
                }
            }

            impl<T0, T1, T2, T3> AttestBuilder<(T0, T1, T2, T3)> {
                /// Setter for the [`harmful` field](Attest#structfield.harmful).
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn harmful<T4>(self, value: T4) -> AttestBuilder<(T0, T1, T2, T3, T4)>
                where
                    T4: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                {
                    let (v0, v1, v2, v3) = self.0;
                    AttestBuilder((v0, v1, v2, v3, value))
                }

                /// Sets the [`harmful` field](Attest#structfield.harmful) to null.
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn harmful_as_null(self) -> AttestBuilder<(T0, T1, T2, T3, ())> {
                    self.harmful(())
                }
            }

            impl<T0, T1, T2, T3, T4> AttestBuilder<(T0, T1, T2, T3, T4)> {
            ...
            impl<
                ...
                T3: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                T4: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
            > ::planus::WriteAs<::planus::Offset<Attest>> for AttestBuilder<(T0, T1, T2, T3, T4)>
            {
            ...
            impl<
                ...
                T3: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                T4: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
            > ::planus::WriteAsOptional<::planus::Offset<Attest>>
                for AttestBuilder<(T0, T1, T2, T3, T4)>
            {
                type Prepared = ::planus::Offset<Attest>;
            ...
            impl<
                ...
                T3: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
                T4: ::planus::WriteAsOptional<::planus::Offset<[u64]>>,
            > ::planus::WriteAsOffset<Attest> for AttestBuilder<(T0, T1, T2, T3, T4)>
            {
                #[inline]
                fn prepare(&self, builder: &mut ::planus::Builder) -> ::planus::Offset<Attest> {
                    let (v0, v1, v2, v3, v4) = &self.0;
                    Attest::create(builder, v0, v1, v2, v3, v4)
                }
            }
            ...
            impl<'a> AttestRef<'a> {
                ...
                /// Getter for the [`helpful` field](Attest#structfield.helpful).
                #[inline]
                pub fn helpful(
                    &self,
                ) -> ::planus::Result<::core::option::Option<::planus::Vector<'a, u64>>>
                {
                    self.0.access(3, "Attest", "helpful")
                }

                /// Getter for the [`harmful` field](Attest#structfield.harmful).
                #[inline]
                pub fn harmful(
                    &self,
                ) -> ::planus::Result<::core::option::Option<::planus::Vector<'a, u64>>>
                {
                    self.0.access(4, "Attest", "harmful")
                }
            }
            ...
            impl<'a> ::core::fmt::Debug for AttestRef<'a> {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    ...
                    f.field("client_seq", &self.client_seq());
                    if let ::core::option::Option::Some(field_helpful) = self.helpful().transpose()
                    {
                        f.field("helpful", &field_helpful);
                    }
                    if let ::core::option::Option::Some(field_harmful) = self.harmful().transpose()
                    {
                        f.field("harmful", &field_harmful);
                    }
                    f.finish()
                }
            }
            ...
            impl<'a> ::core::convert::TryFrom<AttestRef<'a>> for Attest {
                ...
                fn try_from(value: AttestRef<'a>) -> ::planus::Result<Self> {
                    ::core::result::Result::Ok(Self {
                        ...
                        client_seq: ::core::convert::TryInto::try_into(value.client_seq()?)?,
                        helpful: if let ::core::option::Option::Some(helpful) = value.helpful()? {
                            ::core::option::Option::Some(helpful.to_vec()?)
                        } else {
                            ::core::option::Option::None
                        },
                        harmful: if let ::core::option::Option::Some(harmful) = value.harmful()? {
                            ::core::option::Option::Some(harmful.to_vec()?)
                        } else {
                            ::core::option::Option::None
                        },
                    })
            ...
            ///
            /// Generated from these locations:
            /// * Table `Subscribe` in the file `schemas/protocol.fbs:92`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `Health` in the file `schemas/protocol.fbs:97`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `Stats` in the file `schemas/protocol.fbs:99`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `LatencyHistograms` in the file `schemas/protocol.fbs:103`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `VerifyStatus` in the file `schemas/protocol.fbs:105`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `RebuildProjection` in the file `schemas/protocol.fbs:109`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            ///
            /// Generated from these locations:
            /// * Table `CryptoDelete` in the file `schemas/protocol.fbs:114`
            #[derive(
                Clone,
                Debug,
                PartialEq,
            ...
            pub struct BeliefProvenanceRecord {
                ...
                pub last_lsn: u64,
                /// The field `byte_start` in the table `BeliefProvenanceRecord`
                pub byte_start: u32,
                /// The field `byte_end` in the table `BeliefProvenanceRecord`
                pub byte_end: u32,
            }
            ...
            impl<T0, T1> BeliefProvenanceRecordBuilder<(T0, T1)> {
                /// Setter for the [`byte_start` field](BeliefProvenanceRecord#structfield.byte_start).
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn byte_start<T2>(
                    self,
                    value: T2,
                ) -> BeliefProvenanceRecordBuilder<(T0, T1, T2)>
                where
                    T2: ::planus::WriteAsDefault<u32, u32>,
                {
                    let (v0, v1) = self.0;
                    BeliefProvenanceRecordBuilder((v0, v1, value))
                }

                /// Sets the [`byte_start` field](BeliefProvenanceRecord#structfield.byte_start) to the default value.
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn byte_start_as_default(
                    self,
                ) -> BeliefProvenanceRecordBuilder<(T0, T1, ::planus::DefaultValue)>
                {
                    self.byte_start(::planus::DefaultValue)
                }
            }

            impl<T0, T1, T2> BeliefProvenanceRecordBuilder<(T0, T1, T2)> {
                /// Setter for the [`byte_end` field](BeliefProvenanceRecord#structfield.byte_end).
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn byte_end<T3>(
                    self,
                    value: T3,
                ) -> BeliefProvenanceRecordBuilder<(T0, T1, T2, T3)>
                where
                    T3: ::planus::WriteAsDefault<u32, u32>,
                {
                    let (v0, v1, v2) = self.0;
                    BeliefProvenanceRecordBuilder((v0, v1, v2, value))
                }

                /// Sets the [`byte_end` field](BeliefProvenanceRecord#structfield.byte_end) to the default value.
                #[inline]
                #[allow(clippy::type_complexity)]
                pub fn byte_end_as_default(
                    self,
                ) -> BeliefProvenanceRecordBuilder<(T0, T1, T2, ::planus::DefaultValue)>
                {
                    self.byte_end(::planus::DefaultValue)
                }
            }

            impl<T0, T1, T2, T3> BeliefProvenanceRecordBuilder<(T0, T1, T2, T3)> {
            ...
            > ::planus::WriteAs<::planus::Offset<BeliefProvenanceRecord>>
                for BeliefProvenanceRecordBuilder<(T0, T1, T2, T3)>
            {
                ...
                for BeliefProvenanceRecordBuilder<(T0, T1, T2, T3)>
            {
                ...
                fn prepare(
                    ...
                    let (v0, v1, v2, v3) = &self.0;
                    BeliefProvenanceRecord::create(builder, v0, v1, v2, v3)
                }
            }
            ...
            impl<'a> BeliefProvenanceRecordRef<'a> {
                ...
                /// Getter for the [`byte_start` field](BeliefProvenanceRecord#structfield.byte_start).
                #[inline]
                pub fn byte_start(&self) -> ::planus::Result<u32> {
                    ::core::result::Result::Ok(
                        self.0
                            .access(2, "BeliefProvenanceRecord", "byte_start")?
                            .unwrap_or(0),
                    )
                }

                /// Getter for the [`byte_end` field](BeliefProvenanceRecord#structfield.byte_end).
                #[inline]
                pub fn byte_end(&self) -> ::planus::Result<u32> {
                    ::core::result::Result::Ok(
                        self.0
                            .access(3, "BeliefProvenanceRecord", "byte_end")?
                            .unwrap_or(0),
                    )
                }
            }
