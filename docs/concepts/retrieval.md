...
The planner combines lexical, vector, entity, temporal, graph, and belief lanes where available. Identifiers favor entity lookup; temporal questions use windows; how/why queries can include procedures. Reciprocal-rank fusion combines rankings, not incompatible raw scores. Embedding-space identity includes model, revision, dimensions, and role.
